...
def label_CHS_change(smiles1, smiles2, edit_num, replacement_dict, use_stereo):
    ...
    for atom_map in edit_num:
        ...
        if atom_map in atom_map_dict2:
            ...
            H_dict[atom_map]['smiles1'], C_dict[atom_map]['smiles1'], S_dict[atom_map][
                'smiles1'] = atom1.GetNumExplicitHs(), int(atom1.GetFormalCharge()), chiral_type_map[
                atom1.GetChiralTag()]
            H_dict[atom_map]['smiles2'], C_dict[atom_map]['smiles2'], S_dict[atom_map][
                'smiles2'] = atom2.GetNumExplicitHs(), int(atom2.GetFormalCharge()), chiral_type_map[
                atom2.GetChiralTag()]
...
def match_label(reactants, products, replacement_dict, edit_num, retro=True, remote=True, use_stereo=True):
    ...
    atom_map_dict, H_change, Charge_change, Chiral_change = label_CHS_change(smiles1, smiles2, edit_num,
                                                                             replacement_dict, use_stereo)
